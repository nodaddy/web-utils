...
const features = [
  {
    ...
    description:
      "Convert between various file formats with ease. Support for PDF, Word, Excel, and more.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Process and transform data with our powerful tools. JSON, XML, YAML conversion and more.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
      ...
      <div className="container-section">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Our comprehensive suite of tools and solutions helps businesses
